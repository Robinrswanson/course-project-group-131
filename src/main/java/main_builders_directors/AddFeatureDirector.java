...
public class AddFeatureDirector extends FeatureDirector {

    private final FeatureBuilder builder = new AddFeatureBuilder();
    // the builder specific to the director

    /**
     *
     * @return the AddFeatureBuilder, which is specific for Add features
     */
    ...
    /**
     *
     * @return the name of the screen of the feature
     */
    ...
    /**
     * Only ever called by the director, that's why it's private
     */
    private class AddFeatureBuilder implements FeatureBuilder {
